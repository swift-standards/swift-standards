...
///
/// - 8 regions = 2³ (three binary sign choices)
...
///
/// ```swift
/// let point: Octant.Value<Point3D> = .init(tag: .ppp, value: p)
/// ```
...
extension Octant {
    ...
    @inlinable
    public static prefix func ! (value: Octant) -> Octant {
        value.opposite
    }
}
...
extension Octant {
    ...
    public typealias Value<Payload> = Tagged<Octant, Payload>
}
