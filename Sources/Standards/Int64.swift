...
// swift-standards
//
// Extensions for Swift standard library Int64
...
extension Int64 {
    ...
    /// Example:
    /// ```swift
    /// Int64(0x123456789ABCDEF0).bytes(endianness: .little)  // [0xF0, 0xDE, 0xBC, 0x9A, 0x78, 0x56, 0x34, 0x12]
    /// Int64(0x123456789ABCDEF0).bytes(endianness: .big)     // [0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0]
    /// Int64(-1).bytes(endianness: .little)                  // [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]
    /// ```
    @inlinable
