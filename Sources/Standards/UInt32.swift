...
// swift-standards
//
// Extensions for Swift standard library UInt32
...
extension UInt32 {
    ...
    /// Example:
    /// ```swift
    /// UInt32(0x12345678).bytes(endianness: .little)  // [0x78, 0x56, 0x34, 0x12]
    /// UInt32(0x12345678).bytes(endianness: .big)     // [0x12, 0x34, 0x56, 0x78]
    /// ```
    @inlinable
