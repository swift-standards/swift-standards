...
// swift-standards
//
// Extensions for Swift standard library Int32
...
extension Int32 {
    ...
    /// Example:
    /// ```swift
    /// Int32(0x12345678).bytes(endianness: .little)  // [0x78, 0x56, 0x34, 0x12]
    /// Int32(0x12345678).bytes(endianness: .big)     // [0x12, 0x34, 0x56, 0x78]
    /// Int32(-1).bytes(endianness: .little)          // [0xFF, 0xFF, 0xFF, 0xFF]
    /// ```
    @inlinable
